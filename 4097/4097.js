...
const createPage = (errors, formFields) => {
  let pageBody = `
    <head>
      <title>Strelets Vadim 4097. Домашнее задание — развитие формы с валидацией</title>
    </head>
    <body>
      <h1>Strelets Vadim 4097. Домашнее задание — развитие формы с валидацией</h1><div>`;
...
const createUserDataPage = formFields => {
  let body = `
    ...
    <body>
      <h1>Strelets Vadim 4097. Домашнее задание — развитие формы с валидацией</h1>
      <div>
        <h2>Мы вас узнали!</h2>
